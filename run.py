...
start_nearest_points, goal_nearest_points = func.get_neareset_points(rep_vertices)
...
road = gpd.read_file('target_road.gpkg').reset_index()
set_list = []
